...
const socialLinks = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/handiloomwood.global?igsh=eDhna2J5NGJwaHB6",
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/share/1G6Bpw4VFD/?mibextid=wwXIfr",
    icon: "M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z",
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/handiloomwood/",
        ...
        <div className="container mx-auto px-4 sm:px-6 py-16 sm:py-20 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h3 className="font-serif text-3xl sm:text-4xl md:text-5xl font-medium mb-3 sm:mb-4">
              Join the HANDILOOMWOOD Trade Network
            </h3>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="text-xs text-background/40 uppercase tracking-wider">Call Us</span>
                  <span>+91 99175 24064</span>
                </div>
              </a>
              <a
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="text-xs text-background/40 uppercase tracking-wider">WhatsApp</span>
                  <span>+91 94113 00058</span>
                </div>
              </a>
              <div className="flex items-start gap-4 text-background/60">
                ...
                <div className="flex flex-col">
                  <span className="text-xs text-background/40 uppercase tracking-wider">Our Address</span>
                  <span>
